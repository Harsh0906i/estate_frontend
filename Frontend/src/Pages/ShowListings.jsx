...
export default function ShowListings() {
    ...
    return (
        <main>
            ...
            {err && <p className="text-center my-7 text-2xl">Something went wrong!</p>}
            {listing && !loading && !err && (
                <>
                    <Swiper navigation>
                        {
                    ...
                    <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                        ...
                        {currentUser && listing.userRef !== currentUser._id && !contact && (
                            <button className='bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 p-3' onClick={() => setContact(true)}>
                                Contact landlord
                            </button>
                        )}
